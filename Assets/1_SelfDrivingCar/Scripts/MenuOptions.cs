...
{
	private string[] trackNames = new string[]{ "LakeTrack", "JungleTrack", "MountainTrack", "GeneratedTrack"};
...
//		Debug.Log ("constEmissionRate: " + constEmissionRate);
		...
		if (trackNames [trackIndex]=="GeneratedTrack")
		{
...
//		Debug.Log ("constEmissionRate: " + constEmissionRate);
	...
	public void SetLakeTrack ()
	{
		...
		outlines [3].effectColor = new Color (255, 255, 255);
