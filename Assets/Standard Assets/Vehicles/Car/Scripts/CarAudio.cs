...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAudio : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            //float camDist = (GetComponents<Camera>().main.transform.position - transform.position).sqrMagnitude;
            float camDist = (GameObject.FindWithTag("MainCamera").GetComponent<Camera>().transform.position - transform.position).sqrMagnitude;
